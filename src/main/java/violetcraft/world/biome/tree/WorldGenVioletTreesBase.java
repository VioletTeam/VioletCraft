...
public class WorldGenVioletTreesBase extends WorldGenAbstractTree {
    /**
    ...
    public WorldGenVioletTreesBase(boolean par1, int par2, Block blockWood, int par3, Block blockLeaves, int par4, boolean par5) {
        super(par1);
