package violetcraft.entity.model;
...
public class ModelMoonRabbit extends ModelBase
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        if (this.isChild)
        {
            float f = 1.5F;
            GL11.glPushMatrix();
            GL11.glScaled(0.56666666F, 0.56666666F, 0.56666666F);
            GL11.glTranslatef(0.0F, 22.0F * scale, 2.0F * scale);
            ...
            GL11.glTranslatef(0.0F, 36.0F * scale, 0.0F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        EntityMoonRabbit EntityMoonRabbit = (EntityMoonRabbit)entityIn;
        ...
        this.rabbitLeftThigh.rotateAngleX = MathHelper.cos(limbSwing * 50.0F - 21.0F) * 0.017453292F;
        this.rabbitRightThigh.rotateAngleX = MathHelper.cos(limbSwing * 50.0F - 21.0F) * 0.017453292F;
        this.rabbitLeftFoot.rotateAngleX = MathHelper.cos(limbSwing * 50.0F * 0.017453292F);
        this.rabbitRightFoot.rotateAngleX = MathHelper.cos(limbSwing * 50.0F * 0.017453292F);
        this.rabbitLeftArm.rotateAngleX = MathHelper.cos(limbSwing * -40.0F - 11.0F) * 0.017453292F;
        this.rabbitRightArm.rotateAngleX = MathHelper.cos(limbSwing * -40.0F - 11.0F) * 0.017453292F;
    }
